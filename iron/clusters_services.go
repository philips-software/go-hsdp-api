...
func (c *ClustersServices) GetClusters() (*[]Cluster, *Response, error) {
	req, err := c.client.NewRequest("GET", "clusters", nil, nil)
	if err != nil {
		return nil, nil, err
	}
	var clusters struct {
...
func (c *ClustersServices) GetCluster(clusterID string) (*Cluster, *Response, error) {
	req, err := c.client.NewRequest("GET", "clusters/"+clusterID, nil, nil)
	if err != nil {
		return nil, nil, err
	}
	var cluster struct {
...
func (c *ClustersServices) GetClusterStats(clusterID string) (*ClusterStats, *Response, error) {
	req, err := c.client.NewRequest("GET", "clusters/"+clusterID+"/stats", nil, nil)
	if err != nil {
		return nil, nil, err
	}
	var cluster struct {
