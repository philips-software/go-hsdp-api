...
type FirmwareDistributionRequest struct {
	...
	FirmwareComponentVersions []DistributionFirmwareComponentVersion `json:"firmwareComponentVersions" validate:"required,min=1,max=5"`
...
type DistributionFirmwareComponentVersion struct {
	FirmwareComponentVersionId string `json:"firmwareComponentVersionId"`
}
